...
<template>
  <div class="cus">
    ...
    >
      <el-form :model="dialogForm" :rules="dialogFormRules" ref="dialogForm">
        ...
        <el-form-item label="出生日期" prop="cus_birthday">
          <el-date-picker
            v-model="dialogForm.cus_birthday"
            type="date"
            placeholder="選擇日期"
          >
          </el-date-picker>
    ...
    <el-table :data="compData" v-loading="loading" border style="width: 100%">
      ...
      <el-table-column prop="cus_number" label="電話" width="120px" align="center">
      </el-table-column>
      <el-table-column prop="cus_email" label="Email" width="250px" align="center">
      </el-table-column>
      <el-table-column prop="cus_idnumber" label="身分證字號" width="120px" align="center">
      </el-table-column>
      <el-table-column prop="cus_birthday" label="生日" width="100px" align="center">
      </el-table-column>
      ...
      <el-table-column prop="cus_remark" label="備註" width="100px" align="center">
      </el-table-column>
